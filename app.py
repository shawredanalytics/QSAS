...
def render_quxat_home():
    ...
    st.markdown("<style>.ctaWrap .stButton>button{display:block;margin:0 auto}</style>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='qRow'><div class='qCard qCardBlue'><div class='qTitle'>✅ Compliance readiness</div><div class='qSub'>Demonstrate evidence and audit‑readiness.</div></div><div class='qCard qCardGreen'><div class='qTitle'>🛡️ Operational safety</div><div class='qSub'>Reduce risk by strengthening safety‑critical practices.</div></div><div class='qCard qCardPink'><div class='qTitle'>♻️ Continuous improvement</div><div class='qSub'>Track progress over time and sustain improvements.</div></div></div>", unsafe_allow_html=True)
